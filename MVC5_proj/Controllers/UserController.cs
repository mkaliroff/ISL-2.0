...
namespace MVC5_proj.Controllers
{
    public class UserController : Controller
    {
        ...
        [HttpPost]
        public ActionResult saveTheme(ThemeColor themes)
        {
            UserDal dal = new UserDal();
            dal.themes.Add(themes);//in Memorey adding
            dal.SaveChanges();//adding to DB from Memorey
            TempData["yaes"] = "Thank you for contacting us – we will get back to you soon!";
